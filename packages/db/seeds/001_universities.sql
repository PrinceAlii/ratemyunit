...
VALUES
  ...
  ('University of New South Wales', 'UNSW', 'unsw.edu.au', 'https://www.unsw.edu.au', 'https://www.handbook.unsw.edu.au', 'courseloop', true, NOW(), NOW()),
  ('Monash University', 'Monash', 'monash.edu', 'https://www.monash.edu', 'https://handbook.monash.edu', 'courseloop', true, NOW(), NOW()),
  ...
  ('University of Queensland', 'UQ', 'uq.edu.au', 'https://www.uq.edu.au', 'https://my.uq.edu.au/programs-courses', 'custom', true, NOW(), NOW()),
  ('University of Adelaide', 'Adelaide', 'adelaide.edu.au', 'https://www.adelaide.edu.au', 'https://www.adelaide.edu.au/course-outlines', 'custom', true, NOW(), NOW())
